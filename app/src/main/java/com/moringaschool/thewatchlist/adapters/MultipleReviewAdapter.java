...
public class MultipleReviewAdapter extends RecyclerView.Adapter<MultipleReviewAdapter.viewHolder> {
    List<Reviews> list = new ArrayList<Reviews>();
    Context context;
    private View view;

    public MultipleReviewAdapter(List<Reviews> list, Context context) {
        this.list = list;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.dispaly_all, parent, false);
